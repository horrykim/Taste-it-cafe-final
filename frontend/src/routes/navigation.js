import { BarChart3, BookOpen, Boxes, ClipboardCheck, FileChartColumn, LayoutDashboard, List, MapPinned, PackageSearch, ShoppingCart, Sparkles, Tags, Users, UtensilsCrossed } from "lucide-react";
...
export const navigationByRole = {
  OWNER: [
    ...
    { label: "Inventory Management", icon: Boxes, children: [{ label: "Inventory", path: "/app/inventory", icon: PackageSearch }, { label: "Reconciliation", path: "/app/reconciliation", icon: ClipboardCheck }] },
...
export const pageLabels = {
  "/app/dashboard": "Dashboard", "/app/pos": "Point of Sale", "/app/menu": "Menu Management", "/app/inventory": "Inventory", "/app/reconciliation": "Inventory Reconciliation", "/app/sales": "Sales", "/app/reports": "Reports", "/app/reports/ai": "AI Weekly Summary", "/app/branches": "Branch Management", "/app/staff": "Staff Management",
