import { BarChart3, BookOpen, Boxes, ClipboardCheck, FileChartColumn, History, LayoutDashboard, List, MapPinned, PackageSearch, ShoppingCart, Sparkles, Tags, Users, UtensilsCrossed } from "lucide-react";
...
export const navigationByRole = {
  OWNER: [
    ...
    { label: "Inventory Management", icon: Boxes, children: [{ label: "Inventory", path: "/app/inventory", icon: PackageSearch }, { label: "Reconciliation", path: "/app/reconciliation", icon: ClipboardCheck }, { label: "Inventory History", path: "/app/inventory/history", icon: History }] },
